...
<body>
        ...
        <form method="post" >
            ...
            <div class="question">
                ...
                <div class="button-group">
                    <button type="button" id="local-btn" onclick="selectLocal()">Local</button>
                    <button type="button" id="tourist-btn" onclick="selectTourist()">Tourist</button>
                </div>
                <input type="hidden" name="user-status" id="user-status" value="">
            </div>
    ...
    <script>
        ...
        function selectLocal() {
            ...
            document.getElementById("user-status").value = selectedStatus;
        }
